...
import log_plotterUI_plotter
import log_plotterUI_selection
import log_plotterUI_Data_class

class plot_choice(HasTraits): 
    
    data = log_plotterUI_Data_class.Data()
    Draw = Button
    ...
    def do_plot(self):
        for i in self.checklist:
            new = log_plotterUI_plotter.plott(self.data.hdf_path,i)
...
class double_plot_choice(HasTraits):
    ...
    def return_choice(self):
        ...
        new = log_plotterUI_selection.doubleplott(self.data.hdf_path, 
                                    plotlist[0], 
                                    plotlist[1], 
                                    plotlist[2])
        new.configure_traits() 
